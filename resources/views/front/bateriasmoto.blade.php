...
<section class="articulos">
  <div class="mx-auto max-w-screen-xl px-4 pb-0 sm:px-6 sm:py-12 lg:px-8">
    <header class="text-center">
      <h2 class=" font-bold text-gray-900  catalogo-titulo">Baterias de Motos</h2>
    </header>
    ...
    <ul class="mt-3 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <li>
        <a href="#" class="group block overflow-hidden">
          <img
            src="{{ asset('images/bateriamoto1.png') }}"
            alt=""
          ...
          <div class="relative bg-white pt-3">
            ...
            Bateria Quick Starter MotoBike 12v CCA 158 5Ah
            </h3>
      ...
      <li>
        <a href="#" class="group block overflow-hidden">
          <img
            src="{{ asset('images/bateriamoto2.png') }}"
            alt=""
            class="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]"
          />
          ...
          <div class="relative bg-white pt-3">
            <h3 class="text-2xl text-gray-700 group-hover:underline group-hover:underline-offset-4">
            Bateria Quick Starter MotoBike 12v CCA 205 7Ah
            </h3>
      ...
      <li>
        <a href="#" class="group block overflow-hidden">
          <img
            src="{{ asset('images/bateriamoto3.png') }}"
            alt=""
            class="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]"
          />
      ...
      <li>
        <a href="#" class="group block overflow-hidden">
          <img
            src="{{ asset('images/bateriamoto4.png') }}"
            alt=""
            class="h-[350px] w-full object-cover transition duration-500 group-hover:scale-105 sm:h-[450px]"
          />
          ...
          <div class="relative bg-white pt-3">
            <h3 class="text-2xl text-gray-700 group-hover:underline group-hover:underline-offset-4">
            Bateria Quick Starter MotoBike 12v CCA 158 9Ah
            </h3>
