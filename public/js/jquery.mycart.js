...
(function ($) {
  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          ...
          '<td>' + this.name + '</td>' +
          '<td title="Unit Price" class="text-right">' + options.currencySymbol +" " + new Intl.NumberFormat("de-DE").format(this.price) + '</td>' +
          '<td title="Quantity"><input type="number" min="1" style="width: 70px;" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
          '<td title="Total" class="text-right ' + classProductTotal + '">' + options.currencySymbol + " " + new Intl.NumberFormat("de-DE").format(total) + '</td>' +
          '<td title="Remove from Cart" class="text-center" style="width: 20px;"><a href="javascript:void(0);" class="btn btn-xs btn-danger ' + classProductRemove + '">X</a></td>' +
          '</tr>'
        );
      });
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '</tr>' :
        '<div class="alert alert-danger" role="alert" id="' + idEmptyCartMessage + '">El Carro esta Vacio</div>'
      );
    ...
    var showGrandTotal = function () {
      $("#" + idGrandTotal).text(options.currencySymbol + " " + new Intl.NumberFormat("de-DE").format(ProductManager.getTotalPrice()));
    };
    /*
    funcion descuentos
    ...
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      $(this).parent("td").next("." + classProductTotal).text(options.currencySymbol + new Intl.NumberFormat("de-DE").format(price * quantity));
    ...
    $(document).on('click', "." + classCheckoutCart, function () {
      ...
      if (isCheckedOut !== false) {
        ProductManager.clearProduct();
        var isChekedOUt = options.checkoutCart
        $cartBadge.text(ProductManager.getTotalQuantity());
